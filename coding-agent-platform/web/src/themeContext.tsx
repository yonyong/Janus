...
const ANTD_TOKENS: Record<ThemeMode, Partial<NonNullable<ThemeConfig['token']>>> = {
  ...
  paper: {
    colorPrimary: '#2f7d5b',
    colorInfo: '#2f7d5b',
    colorBgLayout: '#efe9db',
    colorBgContainer: '#fbf7ee',
    colorBgElevated: '#fbf7ee',
    colorText: '#3a352c',
  ...
  dark: {
    ...
    colorBgElevated: '#242833',
    colorText: '#e6e8eb',
    colorTextBase: '#e6e8eb',
    colorBorder: '#333a45',
    colorBorderSecondary: '#282e38',
  },
  slate: {
    colorPrimary: '#5b8cff',
    colorInfo: '#5b8cff',
    ...
    colorBgElevated: '#202c46',
    colorText: '#e2e8f5',
    colorTextBase: '#e2e8f5',
    colorBorder: '#2c3a58',
    colorBorderSecondary: '#233150',
  },
}
